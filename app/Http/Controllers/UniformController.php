...
class UniformController extends Controller
{
    ...
    public function copyfinal(Request $request)
    {
        ...
        $season = $request->season;
        $standard = $request->standard;
        $copystandard = $request->copystandard; 
        $standerds = \DB::table('uniforms')->where('school_id',$school_id)->where('gender',$gender)->where('season',$season)->where('standard',$copystandard)->get();
        $itemsizes = \DB::table('item_size')->where('school_id',$school_id)->where('gender',$gender)->where('season',$season)->where('standard',$copystandard)->get();

        if(!empty($standerds)){
            \DB::table('uniforms')->where('school_id',$school_id)->where('gender',$gender)->where('season',$season)->where('standard',$standard)->delete();

            \DB::table('item_size')->where('school_id',$school_id)->where('gender',$gender)->where('season',$season)->where('standard',$standard)->delete();
    ...
    {
        $item_masters = \DB::table('item_masters')->orderby('id','desc')->get();
        return view('admin.uniform.getmodal',compact('item_masters'));
    }
    ...
    public function storeitem(Request $request){
       ...
       try {
            ...
            $items = \DB::table('item_masters')->orderby('id','desc')->get();
